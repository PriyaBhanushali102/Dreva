...
// import { Container, ProductCard, Button, Loader, Input, EnhancedSearchBar } from "../components/index";
...
//               <Link to="/products">
//                 <button className="bg-slate-800 hover:bg-gray-500 text-white px-8 py-3 font-semibold rounded-lg transition-transform hover:scale-105 shadow-md">
//                   Shop Now
//                 </button>
//               </Link>
//               {!isAuthenticated && (
...
//               <div className="relative w-3/4 max-w-xl mx-auto">
//                   <Input
//                     type="text"
//                     value={searchQuery}
...
//       <section className="py-12 bg-gray-300 border-t">
//         <Container>
...
function Home() {
  ...
  // ✅ ADD: Empty filters for home page (shows all products)
  const filters = { limit: 8 }; // Show 8 products on home page
  ...
  // ✅ FIX: Correct navigation path with proper query parameter
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchQuery.trim()) {
      navigate(`/products?q=${encodeURIComponent(searchQuery)}`); // Changed from /products/search?${searchQuery}
    }
  };
